...
public class NoteController {
    ...
    public String delete(@PathVariable("id") Long id) throws NotFountNoteException {
    ...
    @GetMapping("/edit/{id}")
    public String edit(Model model, @PathVariable Long id) throws NotFountNoteException {
        model.addAttribute("note", noteService.getById(id));
        return "edit";
    }

    @PostMapping("edit/{id}")
    public String update(@ModelAttribute("note") Note note) throws NotFountNoteException {
